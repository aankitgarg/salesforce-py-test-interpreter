...
def run_code():
    try:
        ...
        encoded_output = base64.b64encode(str(cleaned_result).encode()).decode()
        return jsonify({"result": encoded_output})
        ...
        encoded_error = base64.b64encode(str(error_message).encode()).decode()
        return jsonify({"result": encoded_error}), 500
